...
export interface MonoweaveConfiguration {
    /**
    ...
    /**
     * The filename to write the changeset to. This is a metadata file which after a monoweave
     ...
     * If no default is set, or set to 0, Monoweave will use its discretion.
     *
    ...
    /**
     * An array of Monoweave plugins. See the plugin section of the documentation for more
     * information.
     *
     * @default []
     */
    ...
    /**
     * Whether to run Monoweave in Prerelease mode. In prerelease mode, versions are not
...
export interface PluginHooks {
    onReleaseAvailable: AsyncSeriesHook<
        [Readonly<YarnContext>, Readonly<MonoweaveConfiguration>, Readonly<ChangesetSchema>],
        void
    >
}
