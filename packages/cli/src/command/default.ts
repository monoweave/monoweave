  ...
  async execute(): Promise<number | void> {
    try {
      ...
      const config: RecursivePartial<MonoweaveConfiguration> = {
        ...
        changesetFilename: this.changesetFilename ?? configFromFile?.changesetFilename ?? undefined,
        changelogFilename: this.changelogFilename ?? configFromFile?.changelogFilename ?? undefined,
        forceWriteChangeFiles: this.forceWriteChangeFiles ?? configFromFile?.forceWriteChangeFiles,
        ...
        autoCommitMessage: this.autoCommitMessage ?? configFromFile?.autoCommitMessage ?? undefined,
      }
