...
- Node >=v20.11.0: For Node 18 support, you can continue to use Monoweave v1. Critical bugs may be backported upon request, however v1 has been stable for a while.
- Yarn Modern >=v4.4.0: We release a new minor version of Monoweave for any patch/minor update of Yarn. For optimal experience with monoweave, ensure you are on the latest version of Yarn at all times.
- Git >=2.13
